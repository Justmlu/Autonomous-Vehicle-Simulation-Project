...
class ExactInference(object):
    ...
    def observe(self, agentX, agentY, observedDist):
        ...
        for i in range(numRows):
            for j in range(numCols):
               ...
               self.belief.setProb(i,j,util.pdf(distance,Const.SONAR_STD,observedDist)*self.belief.getProb(i,j))
    ...
    ##################################################################################
    def elapseTime(self):
          # Create a new belief to store the updated probabilities
          ...
          for (oldTile, newTile), transProb in self.transProb.items():
              ...
              contribution = currentProb * transProb

              newBelief.addProb(newRow,newCol, contribution)

        # Update the belief to new belief and normalize
